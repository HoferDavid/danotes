...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    importProvidersFrom([
      provideFirebaseApp(() => initializeApp({projectId: 'danotes-c9be4', appId: '1:818466774836:web:9278ee1aca3983314ecf61', storageBucket: 'danotes-c9be4.appspot.com', apiKey: 'AIzaSyBdZT4fu_PLlEHzO1_9J2ANxeGlPTVAUms', authDomain: 'danotes-c9be4.firebaseapp.com', messagingSenderId: '818466774836' })),
      provideFirestore(() => getFirestore()),
    ]), importProvidersFrom(provideFirebaseApp(() => initializeApp({"projectId":"danotes-c9be4","appId":"1:818466774836:web:9278ee1aca3983314ecf61","storageBucket":"danotes-c9be4.appspot.com","apiKey":"AIzaSyBdZT4fu_PLlEHzO1_9J2ANxeGlPTVAUms","authDomain":"danotes-c9be4.firebaseapp.com","messagingSenderId":"818466774836"}))), importProvidersFrom(provideFirestore(() => getFirestore())),
  ],
};
